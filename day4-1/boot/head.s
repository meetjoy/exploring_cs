...
after_page_tables:
	...
	pushl $0						# shall be envp, argv, argc
	pushl $0						
...
ignore_int:
	...
	pushl %ecx
	pushl %edx
	push %ds						# when in stack, still takes 4 bytes
	push %es
	push %fs
	movl $0x10, %eax				
	mov %ax, %ds
	...
	mov %ax, %fs
	pushl $int_msg					
	call printk						# function in /kernel/printk.c
	popl %eax
	pop %fs
	pop %es
	pop %ds
...
setup_paging:							
	...
	movl $pg3 + 4092, %edi				# edi->last pager of last page
